...
class PandasUDFType:
    SCALAR: Literal[200] = ...
    GROUPED_MAP: Literal[201] = ...
    GROUPED_AGG: Literal[202] = ...

@overload
def pandas_udf(f: Callable[..., pandas.core.series.Series], returnType: StructField, functionType: Literal[200]) -> Callable[..., Column]: ...
@overload
def pandas_udf(f: Callable[[pandas.core.frame.DataFrame], pandas.core.frame.DataFrame], returnType: StructField, functionType: Literal[201]) -> Callable[..., Column]: ...  # type: ignore
